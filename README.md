...
This repository contains information and documentation about various tools and services.
...
Termius offers free Premium access to students through their Education Program. See [TERMIUS_STUDENT_INFO.md](TERMIUS_STUDENT_INFO.md) for detailed information in both Turkish and English.

### Quick Answer (Türkçe)

**Evet, Termius öğrencilere Premium özelliklerini ücretsiz sunmaktadır!** 

Detaylı bilgi için [TERMIUS_STUDENT_INFO.md](TERMIUS_STUDENT_INFO.md) dosyasına bakınız.

### Quick Answer (English)

**Yes, Termius offers Premium features to students for free!**

For detailed information, see [TERMIUS_STUDENT_INFO.md](TERMIUS_STUDENT_INFO.md).

---

## Contributing

Feel free to submit pull requests to update or improve the documentation.
